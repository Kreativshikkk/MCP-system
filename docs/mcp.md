...
`gitlab_rest_v4` exposes 78 agent-facing tools across repository, issue, merge
...
leaving 221 agent-facing tools from 223 selected provider operations.
...
and YouTrack (221 agent-facing tools total):
