...
def bitbucket_cloud_v2_surface() -> SurfaceSpec:
    specs = (
        ...
        ("list_tags", REPO, ("workspace", "repo_slug"), True),
        ("create_tag", {**REPO, "name": S, "target": S}, ("workspace", "repo_slug", "name", "target"), False),
        ("get_tag", {**REPO, "name": S}, ("workspace", "repo_slug", "name"), True),
